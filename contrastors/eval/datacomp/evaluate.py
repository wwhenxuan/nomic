...
from contrastors.eval.datacomp.eval_utils import evaluate_model
...
def submit_to_firebase(training_info, args, results):
    ...
    data = {
        ...
        or training_info["scale_config"]["train_num_samples"],
...
if __name__ == "__main__":
    ...
    train_info = {
        "checkpoint": args.train_output_dir,
        "scale_config": {"model": "large"},
    }
