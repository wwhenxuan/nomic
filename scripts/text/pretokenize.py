...
dataset = load_dataset(
    "statmt/cc100", args.language, split="train", num_proc=args.num_workers
)
...
tokenized_datasets = dataset.map(
    group_texts, batched=True, remove_columns=["text"], num_proc=num_proc
)
...
tokenized_datasets = tokenized_datasets.map(
    group_texts, batched=True, num_proc=num_proc, desc="Grouping texts"
)
